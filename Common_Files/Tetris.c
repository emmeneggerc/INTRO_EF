...
static void PrintWelcome(void) {
  ...
  EVNT_ClearEvent(EVNT_TETRIS_LEFT);
  EVNT_ClearEvent(EVNT_TETRIS_RIGHT);
  EVNT_ClearEvent(EVNT_TETRIS_UP);
  EVNT_ClearEvent(EVNT_TETRIS_DOWN);
  EVNT_ClearEvent(EVNT_TETRIS_DROP);
